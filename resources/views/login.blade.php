...
<section class="bg-gray-50 dark:bg-gray-900">
  <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
      <a href="#" class="flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white">
        <img class="w-50 h-30 mr-2" src="https://www.fatectatui.edu.br/site4/imagens/logoMobile.png" alt="logo">
        @error('email')
        <div class=" bg-red-300 rounded-2xl text-red-900 p-4">{{ $message }}</div>
        @enderror
          <form action="{{route('logar')}}" method="POST" class="space-y-8">
          @csrf
      </a>
          ...
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form class="space-y-4 md:space-y-6" action="#">
                  ...
                  <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                      Não tem uma conta? <a href="criar-conta" class="font-medium text-primary-600 hover:underline dark:text-primary-500">Crie a conta</a>
                  </p>
              </form>
          </div>
      </div>
