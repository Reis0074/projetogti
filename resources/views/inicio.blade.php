...
<section class="bg-white dark:bg-gray-900">
  <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
      <div class="mx-auto max-w-screen-sm">
          <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">O curso de GTI</h2>
          <p class="mb-8 font-light text-gray-500 lg:mb-16 sm:text-xl dark:text-gray-400">Conheça um dos melhores cursos de ensino superior da cidade de Tatuí, nele você terá conhecimento da área de gestão</p>
      </div> 
      <div class="grid mb-8 lg:mb-12 lg:grid-cols-2">
          <figure class="flex flex-col justify-center items-center p-8 text-center bg-gray-50 border-b border-gray-200 md:p-12 lg:border-r dark:bg-gray-800 dark:border-gray-700">
              <blockquote class="mx-auto mb-8 max-w-2xl text-gray-500 dark:text-gray-400">
                  <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Tenha aulas com professores mestres e especialistas</h3>
                  <p class="my-4">"No curso de GTI tive oportunidade de conhecer diversos professores com sólidos conhecimentos na área, me ajudaram a direcionar minha carreira.</p>
                  <p class="my-4">O curso foi o ponto de virada em minha vida e minha carreira, a partir dele.</p>
                  <p class="my-4">Se você quer seguir na área fortemente recomendo!"</p>
              </blockquote>
              <figcaption class="flex justify-center items-center space-x-3">
                  ...
                  <div class="space-y-0.5 font-medium dark:text-white text-left">
                      <div>Ana Clara</div>
                      <div class="text-sm font-light text-gray-500 dark:text-gray-400">Gestora de TI na Toyata S/A</div>
                  </div>
              </figcaption>    
          </figure>
          <figure class="flex flex-col justify-center items-center p-8 text-center bg-gray-50 border-b border-gray-200 md:p-12 dark:bg-gray-800 dark:border-gray-700">
              <blockquote class="mx-auto mb-8 max-w-2xl text-gray-500 dark:text-gray-400">
                  <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Conhecimento para diversas áreas</h3>
                  <p class="my-4">O curso não fornece apenas conhecimento para quem quer seguir na área de gestão, mas também oferece conhecimento para uma váriedades de áreas, já que tudo em nossa vida é baseado em gestão e atualmente tudo é fortemente ligado ao TI.</p>
                  <p class="my-4">Meu emprego atual na empresa XyZ realizo atividades na área de produção e design de produtos, porém aplico vários conhecimentos vistos ao decorrer do curso</p>
              </blockquote>
              <figcaption class="flex justify-center items-center space-x-3">
                  ...
                  <div class="space-y-0.5 font-medium dark:text-white text-left">
                      <div>Roberta Dias</div>
                      <div class="text-sm font-light text-gray-500 dark:text-gray-400">Designer de produtos na Dropbox</div>
                  </div>
              </figcaption>    
          </figure>
